      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <Key className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-faint" />
            <input
              ...
              className="w-full pl-10 pr-12 py-3 border-2 border-line rounded-xl bg-surface text-ink placeholder:text-muted focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all"
            />
            <button
              type="button"
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    session.isCurrent ? "bg-green-100" : "bg-surface-2"
                  }`}
                >
                  <DeviceIcon
                    className={`w-5 h-5 ${
                      session.isCurrent ? "text-green-600" : "text-muted"
                    }`}
                  />
                </div>
