    ...
    <div className="py-2">
      ...
      <div className="space-y-1">
        {searches.map((query) => (
          <div
            key={query}
            className="flex items-center gap-2 px-4 py-2 hover:bg-surface-2 group"
          >
            <button
            ...
            <button
              ...
              className="opacity-0 group-hover:opacity-100 p-1 text-faint hover:text-muted transition-all"
            >
