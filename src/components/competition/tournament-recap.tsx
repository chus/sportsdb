  ...
  return (
    <section className="bg-surface rounded-xl border border-line overflow-hidden">
      <div className="px-6 py-4 border-b border-line flex items-center gap-2">
        ...
        <h2 className="text-lg font-bold text-ink">{periodLabel} Recap</h2>
      ...
      <div className="p-6">
        ...
        {Array.isArray(summary.topPerformers) && summary.topPerformers.length > 0 && (
          <div className="mb-6">
            <h4 className="text-sm font-medium text-muted uppercase tracking-wide mb-3 flex items-center gap-2">
            ...
            <div className="space-y-2">
              {summary.topPerformers.map(
                (performer: { playerId: string; playerName: string; reason: string }, idx: number) => (
                  <div
                    key={idx}
                    className="flex items-start gap-3 text-sm p-2 bg-surface-2 rounded-lg"
                  >
