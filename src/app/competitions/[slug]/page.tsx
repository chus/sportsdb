                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-neutral-50 text-left text-sm text-neutral-500">
                        ...
                        <th className="px-2 sm:px-4 py-3 font-medium text-center">Pts</th>
                      </tr>
                    </thead>
                        ...
                        <tr key={team.id} className="hover:bg-neutral-50 transition-colors">
                          ...
                          <td className="px-2 sm:px-4 py-3">
                            ...
                            >
                              ...
                              <span className="font-medium hidden md:inline">{team.name}</span>
                              <span className="font-medium md:hidden">{team.shortName || team.name}</span>
                            </Link>
                          </td>
                          <td className="px-2 sm:px-4 py-3 text-center text-neutral-600">{standing.played}</td>
                          <td className="px-2 sm:px-4 py-3 text-center text-neutral-600">{standing.won}</td>
                          <td className="px-2 sm:px-4 py-3 text-center text-neutral-600 hidden sm:table-cell">{standing.drawn}</td>
                          <td className="px-2 sm:px-4 py-3 text-center text-neutral-600">{standing.lost}</td>
                          <td className={`px-2 sm:px-4 py-3 text-center font-medium hidden sm:table-cell ${
