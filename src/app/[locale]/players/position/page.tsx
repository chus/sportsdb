            ...
            {positions.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="bg-surface rounded-xl border border-line p-6 hover:shadow-xl transition-shadow flex items-center justify-between group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-lg font-semibold text-ink group-hover:text-blue-600 transition-colors">
                        {item.position}s
                      </span>
                      ...
                      {meta && (
                        <div className="text-xs text-faint mt-0.5">{meta.description}</div>
                      )}
                    </div>
                  </div>
                  <ChevronRight className="w-5 h-5 text-faint group-hover:text-blue-600 transition-colors" />
                </Link>
              );
            })}
          </div>
