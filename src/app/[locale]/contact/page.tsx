          ...
          <div className="grid md:grid-cols-3 gap-6">
            {contactMethods.map((method) => (
              <a
                ...
                className="bg-surface rounded-xl border border-line p-6 hover:shadow-lg hover:border-blue-200 transition-all group"
              >
          ...
          <form className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-3 rounded-lg border border-line focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
            ...
            <div>
              ...
              <textarea
                ...
                name="message"
                rows={6}
                className="w-full px-4 py-3 rounded-lg border border-line focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none"
